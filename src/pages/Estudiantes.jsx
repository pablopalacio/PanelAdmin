        ...
        <div className="bg-white rounded-xl shadow-sm p-4 lg:p-6">
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3">
            ...
            <div className="flex justify-center sm:justify-end space-x-1 lg:space-x-2">
              <button className="px-2 py-1 lg:px-3 lg:py-1 border border-gray-300 rounded-lg text-gray-600 hover:bg-gray-100 transition-colors text-xs lg:text-sm cursor-pointer">
                Anterior
              </button>
              <button className="px-2 py-1 lg:px-3 lg:py-1 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors text-xs lg:text-sm cursor-pointer ">
                1
              </button>
              <button className="px-2 py-1 lg:px-3 lg:py-1 border border-gray-300 rounded-lg text-gray-600 hover:bg-gray-100 transition-colors text-xs lg:text-sm cursor-pointer ">
                2
